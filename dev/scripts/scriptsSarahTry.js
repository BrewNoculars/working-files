...
breweriesNearBy.getBreweries = function (userLocation) {
	$.ajax ({
		...
		// console.log(brewery);
		// breweriesNearBy.getInfooo(brewery.data);
...
// breweriesNearBy.public = function(array) {
// 	breweryArr = array.filter(function(beer) {
// 		return beer.openToPublic === "Y";
// 	});
// 	breweriesNearBy.getInfooo('open to pubic', breweryArr);
// };
